...
![The Broad Street Pump (John Snow/ National Geographic)](../pictures/John_Snow_Cholera_by_National_Geographic.jpg){
  width=500 
  fig-align='right' 
}
:::
...
1) Each layer is the same variable from a different time. e.g. mean monthly temperature from January -> December (12 layers per stack) 
