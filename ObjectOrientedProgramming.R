...
#' 
## ----import Vector Data, echo = F, warning = F, message = F--------------------------------------------------------------------------
# getwd()
...
#' 
## ----Object types - Create Types, echo = F, warning = F, message = F-----------------------------------------------------------------
...
#' 
## ----Object Types 1 make a vector, comment = ""--------------------------------------------------------------------------------------
rast_vals_char[1:3]

#' 
## ----Object Types 2 evaluate a vector, echo = F, comment=""--------------------------------------------------------------------------
...
#' 
## ----Object Types 3 make a matrix, comment = ""--------------------------------------------------------------------------------------
...
#' 
## ----Object Types 5 evaluate a matrix, echo = F, comment=""--------------------------------------------------------------------------
...
#' 
## ----Object Types 8 Junk Vector, comment = ""----------------------------------------------------------------------------------------
junk <- c(1, 'A', 'alpahbet soup', '$')
print(junk)

#' 
## ----Object Types 9 clean junk, echo = F---------------------------------------------------------------------------------------------
rm(junk)

#' 
#' ## 'Introduction' to S3 Objects
#' 
## ----Object Types POSIXct 1, echo = F, comment = "", warning = F, message = F--------------------------------------------------------
...
#' 
## ----Object Types POSIXct 2, echo = F, comment = "", warning = F, message = F--------------------------------------------------------
...
#' 
## ----Object Types POSIXct 3, echo = F, comment = "", warning = F, message = F--------------------------------------------------------
...
#' 
## ----Object Types POSIXct 4, echo = F, comment = ""----------------------------------------------------------------------------------
...
## ----Object Types Units 2, comment = ""----------------------------------------------------------------------------------------------
units(fifty_meters) <- units::make_units(yards)
print(fifty_meters)

#' 
## ----Object Types Units 3, echo = F, comment = ""------------------------------------------------------------------------------------
...
#' 
## ----Object Types 1 - Data Frame, echo = F, comment = ""-----------------------------------------------------------------------------
...
#' 
## ----Object Types 2 - Data Frame, echo = F, comment = ""-----------------------------------------------------------------------------
...
#' 
## ----Object Types - Tibble Simple Feature 1, echo = F, comment = ""------------------------------------------------------------------
...
#' 
## ----Object Types - Tibble Simple Feature 2, echo = F, comment = ""------------------------------------------------------------------
...
#' 
## ----Object Types - Tibble Simple Feature 3, comment = ""----------------------------------------------------------------------------
iris <- iris %>% 
...
#' 
## ----Object Types - Tibble Simple Feature 4, echo = F, comment = ""------------------------------------------------------------------
...
#' 
## ----Object Types - SpatialPolygonsDataFrame 1, comment = ""-------------------------------------------------------------------------
...
#' 
## ----Object Types - SpatialPolygonsDataFrame 2, comment = ""-------------------------------------------------------------------------
...
#' 
## ----Object Types - SpatialPolygonsDataFrame 3, comment = ""-------------------------------------------------------------------------
...
#' 
## ----Object Types - SpatialPolygonsDataFrame 4, comment = ""-------------------------------------------------------------------------
...
#' 
## ----Object Types - SpatialPolygonsDataFrame 5, echo = F, comment = ""---------------------------------------------------------------
...
## ----Object Types - SpatialPolygonsDataFrame 6, echo = F, comment = ""---------------------------------------------------------------
...
#' 
## ----Object Types Raster Layer 1, echo = F, comment = ""-----------------------------------------------------------------------------
...
#' 
## ----Object Types Raster Layer 2, echo = F, comment = ""-----------------------------------------------------------------------------
...
#' 
## ----Object Types - Clean Environment, echo = F--------------------------------------------------------------------------------------
...
#' 
## ----Create an S3 object 1, message = F, warning = F, comment = ""-------------------------------------------------------------------
...
#' 
## ----Create an S3 object 2, warning = F, comment = ""--------------------------------------------------------------------------------
...
#' 
## ----Create an S3 object 3, warning = F, comment = ""--------------------------------------------------------------------------------
...
#' 
## ----Create an S3 object 4, warning = F, eval = F------------------------------------------------------------------------------------
...
#' 
## ----Create an S3 object 5, warning = F, echo = F------------------------------------------------------------------------------------
...
## ----Create an S4 object, message = F, warning = F, comment = ""---------------------------------------------------------------------
...
#' 
## ----Populate an S4 object, message = F, warning = F, comment = ""-------------------------------------------------------------------
...
## ----Create a more complex S4 object, message = F, warning = F, comment = ""---------------------------------------------------------
...
#' 
## ----Populate a more complex S4 object, message = F, warning = F, comment = ""-------------------------------------------------------
