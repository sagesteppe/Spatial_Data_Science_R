...
```{r, fig.show='hold', echo = F, fig.align="center", fig.cap = "Sacramento Mountains, New Mexico"}
knitr::include_graphics("./pictures/Sacramento_Mtns_NM.jpg")
```
...
- Since then GIS waited to flourish until computational ability increased dramatically in the 90's
...
```{r UTM Zones of the Continental USA,   fig.align="center", echo = F, message = F, warning=F, fig.cap = "UTM Zones of the Conterminous USA. data by ESRI"}
...
```{r, out.width = "40%", fig.align="center", fig.show='hold', echo = F, fig.cap = "Geographic Coordinate Reference System. by: Anna Krystalli"}
...
```{r sf with ggplot2 - 2, out.width = "75%", fig.show='hold', fig.align="center"}
...
```{r sf with ggplot2 - 3, out.width = "75%", fig.show='hold', fig.align="center"}
ggplot(north_carolina) +
