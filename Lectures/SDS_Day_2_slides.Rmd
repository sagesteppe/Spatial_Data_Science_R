...
```{r, fig.show='hold', echo = F, fig.align="center", fig.cap = "Pioneer Mountains, Idaho"}
knitr::include_graphics("./pictures/Pioneer_Mtns_ID.jpg")
```
...
```{r Plot Topology, echo = F, fig.cap = "Spatial Predicates after Egenhofer and Herring (1990)", fig.align="center"}
...
- we can make the geometry simple with st_make_valid()
